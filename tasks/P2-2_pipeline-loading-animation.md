...
- [ ] Run Pipeline button shows spinner while running
- [ ] RunStatus card has animated loading indicator during pending/running
- [ ] Clear visual distinction between "loading" and "done" states
