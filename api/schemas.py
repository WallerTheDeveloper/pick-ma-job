...
def sanitize_run_result(result: dict) -> dict:
    ...
    return {
        ...
        "jobs_skipped_blacklist": result.get("jobs_skipped_blacklist", 0),
        "jobs_skipped_language": result.get("jobs_skipped_language", 0),
        "jobs_skipped_closed": result.get("jobs_skipped_closed", 0),
        "jobs_skipped_low_score": result.get("jobs_skipped_low_score", 0),
